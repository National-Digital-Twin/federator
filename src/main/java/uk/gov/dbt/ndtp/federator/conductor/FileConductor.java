 ...
 */
public class FileConductor extends AbstractKafkaEventMessageConductor<String, FileFetchRequest> {
    ...
    private FileConductor(
            ...
            MessageConsumer<KafkaEvent<String, FileFetchRequest>> consumer,
            MessageProcessor<KafkaEvent<String, FileFetchRequest>> postProcessor) {
